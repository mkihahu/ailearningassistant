...
const FlashcardManager = ({ documentId }) => {
  ...
  const handleReview = async (index) => {
    ...
    try {
      ...
      toast.error(error.message || "Failed to reveiw flashcard");
    }
  };
    ...
    return (
      <div className="space-y-8">
        ...
        <button
          ...
          className="group inline-flex items-center gap-2 text-sm fonme text-slate-600 hover:text-emerald-600 transition-colors duration-200"
        >
          <ArrowLeft
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="group flex items-center ga2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
            >
              <ChevronLeft
  ...
  return (
    <>
      ...
      <Modal
        ...
        title="Delete Flascard Set?"
      >
        <div className="space-y-6">
          <p className="text-sm text-slate-600">
            Are you sure you want to delete flashcard set? This action cannot be
            undone and all cards will be permanently removed.
          </p>
