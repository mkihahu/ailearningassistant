...
import Flashhcard from "../../components/flashcards/Flashcard";
...
const FlashcardPage = () => {
  ...
  const handleDeleteFlashcardSet = async () => {
    ...
    try {
      ...
      toast.success("Flascard set deleted successfully");
    } catch (error) {
    ...
    return (
      <div className="flex flex-col items-center space-y-6">
        <div className="w-full max-w-md">
          <Flashhcard flashcard={currentCard} onToggleStar={handleToggleStar} />
        </div>
