...
const QuizResultsPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Score Card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-xl shadow-xl shadow-slate-200/50 p-8 mb-6">
              ...
              <div className="space-y-3 mb-4">
                {result.options.map((option, optIndex) => {
                  ...
                  return (
                    <div
                      key={optIndex}
                      className={`relative px-4 py-3 rounded-lg border-2 transition-all duration-100 ${
                        isCorrectOption
